...
- These files contain the logic for previous attempts for [PoseMario](https://github.com/WillUHD/PoseMario) to work in Java. They might not run as fast, but they are worth archiving.
